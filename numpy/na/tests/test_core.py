...
:author: Vasco Conceição and Henrique Luz
:contact: vasco.v.conceicao_at_tecnico_dot_ulisboa_dot_pt and henrique_dot_luz_at_tecnico_dot_ulisboa_dot_pt
"""
__author__ = "Vasco Conceição and Henrique Luz"
